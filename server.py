...
_DOC_CATEGORIES = [
    ...
    },
    {
        ...
        "docs": [
            ...
            "algorithms/REALTIME_STATE_HISTORY_ANALYSIS.md",
            "algorithms/ALGORITHMS_PLAYER_MODEL.md",
            "algorithms/PROFILE_AUDIT.md",
