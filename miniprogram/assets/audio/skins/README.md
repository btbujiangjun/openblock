...
- Mahjong uses Kenney Casino chip/dice/die object sounds instead of generic UI sounds.
- Water/Ocean/Koi/Summer use bubble/splash/water SFX.
- Pets/Fairy/Forest/Jurassic/Demon can use cute/bug/howl/roar creature SFX for more lifelike/personified feedback.
- Excludes harsh or low-value tokens: glitch/scratch/error/bong/close/minimize/back/scream/hurt/burp/cough/snore/click/tick.
- External files are research overrides; code falls back to procedural SFX when missing or disabled.

Miniprogram lookup: <skinId>/<event> or _groups/<group>/<event>.
