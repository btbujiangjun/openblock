 ...
 */
function runSpawnRules(rules, initialState, ctx, opts = {}) {
...
const _internal = { _sortRules };

module.exports = { _internal, POC_HOLES_RULE, runSpawnRules, validateRules };
