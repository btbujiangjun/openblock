...
const MESSAGES = {
  'zh-CN': {
    ...
    best: '最佳',
    bestGap: '差 {n} 分',
    /* v1.60.46：HUD 等级 + 称号（与 web ui.stat.ability / progress.rank.* 对齐） */
    ability: '能力',
  ...
  en: {
    ...
    effectIconBonus: 'Royal Flush Clear',
    effectNewRecord: 'New Record',
    visualOn: 'Visual FX: On',
    visualOff: 'Visual FX: Off',
    audioOn: 'Sound: On',
    audioOff: 'Sound: Off',
    qualityHigh: 'High · Animated',
    ...
    skinNames: {
      ...
      farm: '🐄 Farm Life',
      desert: '🐫 Desert Oasis',
      summer: '🏖️ Summer Breeze',
      apple: '🍎 Crafted Apple',
      cafe: '☕ Cafe Afternoon',
      fiesta: '🎉 Fiesta Carnival',
      arcadeCabinet: '📺 Arcade Cabinet',
      circuitBoard: '🧲 Circuit Board',
      toyBox: '🧸 Toy Box',
      mineralCave: '💍 Mineral Cave',
      alchemyLab: '⚗️ Alchemy Lab',
      botanicalStudy: '🥀 Botanical Study',
      spaceDock: '🛰️ Space Dock',
      dungeonLoot: '🪤 Dungeon Loot',
      origamiPaper: '✉️ Origami Paper',
