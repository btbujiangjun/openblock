...
let _softDeps_decisionTable = {}; try { _softDeps_decisionTable = require('./lib/decisionTable'); } catch (_e) { /* miniprogram 不分发 lib/ 子目录，软依赖回退空骨架 */ } const { applyDecisionTable } = _softDeps_decisionTable;
const {
