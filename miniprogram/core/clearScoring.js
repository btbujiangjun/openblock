 ...
 */
function computeClearScore(strategyId, result, scoringOverride, comboCount = 0) {
...
module.exports = { bonusEffectHoldMs, COMBO_MULTIPLIER_CFG, computeClearScore, deriveComboMultiplier, deriveNextComboCount, detectBonusLines, ICON_BONUS_LINE_MULT, isComboBroken, MONO_NEAR_FULL_COLOR_WEIGHT, monoNearFullLineColorWeights, PERFECT_CLEAR_MULT, pickThreeDockColors };
