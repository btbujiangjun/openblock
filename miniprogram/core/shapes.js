 ...
 */
function pickShapeByCategoryWeights(weights) {
...
module.exports = { getAllShapes, getShapeById, getShapeCategory, getShapesByCategory, pickShapeByCategoryWeights, SHAPES };
