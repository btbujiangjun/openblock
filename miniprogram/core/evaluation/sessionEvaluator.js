 ...
 */
function buildSessionEvalRecord(ledger, opts = {}) {
...
const SESSION_EVAL_DEFAULT_GUARD = DEFAULT_GUARD;

module.exports = { buildSessionEvalRecord, SESSION_EVAL_DEFAULT_GUARD };
