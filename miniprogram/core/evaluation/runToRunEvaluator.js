...
function buildIntraDayReport(sessions, opts = {}) {
...
function buildMultiDayReport(sessions, opts = {}) {
 ...
 */
function compareModelVersions(groupA, groupB, opts = {}) {
...
module.exports = { buildIntraDayReport, buildMultiDayReport, compareModelVersions };
