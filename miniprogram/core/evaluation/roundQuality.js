...
const ROUND_DEFAULT_WEIGHTS = DEFAULT_WEIGHTS;
const ROUND_DEFAULT_REGRET_BLEND = DEFAULT_REGRET_BLEND;
const ROUND_DEFAULT_THRESHOLDS = DEFAULT_THRESHOLDS;

module.exports = { evaluateRound, ROUND_DEFAULT_REGRET_BLEND, ROUND_DEFAULT_THRESHOLDS, ROUND_DEFAULT_WEIGHTS };
