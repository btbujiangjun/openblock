 ...
 */
function deriveEffectivePb(personalBest, dd = {}) {
 ...
 */
function getSpawnStressFromScore(score, opts = {}) {
 ...
 * @param {number} t
 */
function blendShapeWeightsTowardHard(baseStrategyId, t) {
 ...
 */
function getRunDifficultyModifiers(runStreak) {
 ...
 */
function resolveLayeredStrategy(baseStrategyId, score, runStreak, opts = {}) {
    const base = getStrategy(baseStrategyId);
...
module.exports = { blendShapeWeightsTowardHard, deriveEffectivePb, getRunDifficultyModifiers, getSpawnStressFromScore, resolveLayeredStrategy };
