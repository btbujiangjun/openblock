/**
 * 小程序运行时不稳定支持 require JSON；这里以 JS 模块形式提供形状数据。
 * 数据来自 shared/shapes.json 的小程序裁剪版。
 */
module.exports = {
  categoryOrder: [
    'lines',
  ...
  byCategory: {
    ...
    lshapes: [
      ...
      { id: 'l5-a', name: 'L 五连 0°', category: 'lshapes', data: [[1, 1, 1], [1, 0, 0], [1, 0, 0]] },
      { id: 'l5-b', name: 'L 五连 90°', category: 'lshapes', data: [[1, 1, 1], [0, 0, 1], [0, 0, 1]] },
      { id: 'l5-c', name: 'L 五连 180°', category: 'lshapes', data: [[1, 0, 0], [1, 0, 0], [1, 1, 1]] },
      { id: 'l5-d', name: 'L 五连 270°', category: 'lshapes', data: [[0, 0, 1], [0, 0, 1], [1, 1, 1]] },
    ],
    jshapes: [
