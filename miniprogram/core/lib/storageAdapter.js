 ...
 *
 * 用法：
 *   const { safeReadJson, safeWriteJson, safeRemoveKey } = require('../lib/storageAdapter');
...
module.exports = { safeReadJson, safeRemoveKey, safeWriteJson };
