 ...
 *
 * 用法：
 *   const { createMulberry32, defaultRng } = require('./lib/seededRng');
 *
 ...
 */
function fisherYatesInPlace(arr, rng, onSwap) {
...
module.exports = { createMulberry32, defaultRng, fisherYatesInPlace, fnv1a, pickIndex };
