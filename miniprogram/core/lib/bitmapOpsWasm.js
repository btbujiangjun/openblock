 ...
 *
 * 用法：
 *   const { tryLoadWasm } = require('./bitmapOps');
 *   const { wasmBitmapLoader } = require('./bitmapOpsWasm');
 ...
 */
async function wasmBitmapLoader() {
...
/* 测试 reset */
function _resetWasmCacheForTest() { _cached = null; }

const _internal = { WASM_BYTES };

module.exports = { _internal, _resetWasmCacheForTest, wasmBitmapLoader };
