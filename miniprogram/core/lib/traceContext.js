...
function _resetTraceContext() {
    _current = null;
}

module.exports = { _resetTraceContext, annotate, currentTrace, newSpanId, newTraceId, withNewTrace, withSpan };
