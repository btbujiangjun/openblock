 ...
 */
function loadAnalyticsSnapshotSync() {
    return _lsGet();
}
 ...
 */
function queueAnalyticsSave(payload) {
 ...
 */
function getAnalyticsStoreStats() {
...
function resetAnalyticsStoreStats() {
 ...
 */
function _resetAnalyticsStoreForTests() {
    _idbAvailable = null;
    _dbPromise = null;
    _pendingPayload = null;
    if (_debounceTimer) { clearTimeout(_debounceTimer); _debounceTimer = null; }
...
module.exports = { _resetAnalyticsStoreForTests, flushAnalyticsNow, getAnalyticsStoreStats, loadAnalyticsSnapshot, loadAnalyticsSnapshotSync, queueAnalyticsSave, resetAnalyticsStoreStats };
