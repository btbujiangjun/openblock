...
function getBitmapOps() { return _ops; }

/**
 * 工厂：返回独立 ops（测试用，不影响全局）。
 */
function createBitmapOps() {
    return {
        popcount32: popcount32Js,
        ctz32: ctz32Js,
        popcountMask: popcountMaskJs,
 ...
 */
async function tryLoadWasm(opts = {}) {
...
/* 测试 reset */
function _resetBitmapOpsForTest() {
...
module.exports = { _resetBitmapOpsForTest, createBitmapOps, ctz32Js, getBitmapOps, popcount32Js, popcountMaskJs, tryLoadWasm };
