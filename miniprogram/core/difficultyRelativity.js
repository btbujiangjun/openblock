 ...
 */
const RELATIVITY_INTENT = Object.freeze({
    OFF: 'off',
 ...
 */
function resolveRelativityIntent(ctx = {}) {
 ...
 */
function resolveRelativityBypass(cfg, ctx = {}) {
 ...
 */
function solveObjectiveTarget(stress, cfg, ctx = {}) {
 ...
 */
function alignmentMultiplier(candidateVec, bStar, cfg, calibration) {
...
module.exports = { alignmentMultiplier, RELATIVITY_INTENT, resolveRelativityBypass, resolveRelativityIntent, solveObjectiveTarget };
