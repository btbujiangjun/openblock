...
/* ── 付费深度档阈值（元，累计 IAP 净额） ───────────────────────────────── */
const SPEND_TIERS = Object.freeze([
...
const VALUE_TIERS = Object.freeze([
...
const VALUE_TIER_BENEFITS = Object.freeze({
    T0: [],
    T1: ['ad_reduction'],
 ...
 */
function deriveSpendTier(spend) {
 ...
 */
function deriveValueTier(spend) {
    const s = Math.max(0, _num(spend));
...
module.exports = { deriveLifecycleStage, deriveSegment5, deriveSegments, deriveSpendTier, deriveValueTier, SPEND_TIERS, VALUE_TIER_BENEFITS, VALUE_TIERS };
