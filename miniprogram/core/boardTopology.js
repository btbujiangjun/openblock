const { getAllShapes, getRegularShapes } = require('./shapes');
 ...
 */
function countUnfillableCells(grid, shapes, opts) {
...
function computeCoverableCells(grid, shapes, opts) {
 ...
 */
function analyzeBoardTopology(grid, opts) {
