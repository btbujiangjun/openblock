...
function resetBlockSpawnDfsStats() {
...
module.exports = { _estimateTopDriver, _pickFallbackSafe, _pressureHoleForcing, _reliefGapShapeIds, _resolveSpecialPools, _sanitizeShapeArr, _tryInjectDuplicates, _tryInjectSpecial, analyzePerfectClearSetup, bestHoleReduction, bestMultiClearPotential, canTripletPerfectClear, computeCandidatePlacementMetric, countLegalPlacements, DUP_INJECT_CONFIG, evaluateTripletSolutions, generateDockShapes, generateDockShapesLayered, getBlockSpawnDfsStats, getLastSpawnDiagnostics, hasSpecialShape, pickWeighted, RELIEF_FILL_FLOOR_MILD, RELIEF_FILL_FLOOR_URGENT, RELIEF_HOLE_FILL_MIN, resetBlockSpawnDfsStats, resetSpawnMemory, SPECIAL_PRESSURE_SHAPES, SPECIAL_RELIEF_SHAPES, SPECIAL_SHAPE_WEIGHTS, SPECIAL_SHAPES, validateSpawnTriplet };
