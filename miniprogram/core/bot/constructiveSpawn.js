 ...
 */
function findCompleterShapes(grid, targetCells, catalog, opts = {}) {
 ...
 */
function findSetupShapes(grid, catalog, opts = {}) {
 ...
 * @returns {boolean}
 */
function isClearTargetValid(grid, target, catalog, opts = {}) {
    const maxEmpty = opts.maxEmpty ?? 2;
