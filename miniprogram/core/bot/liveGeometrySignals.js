...
const { analyzePerfectClearSetup, computeCandidatePlacementMetric } = require('./blockSpawn');
...
module.exports = { _countMultiClearCandidatesFromShapePool, _mergeLiveGeometrySignals };
