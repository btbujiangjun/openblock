...
export const SPAWN_INTENT_NARRATIVE = {
    ...
    /* v1.70 warm_run：温暖局期间出块强制走"大块 + 强清行 + 爽感编排"管线，
     * 文案保持中性温暖（不直接暴露"我们在保护你"的策略术语），让玩家通过
     * 大方块/规则块 + 多消/清屏的体感自然感知。叙事与 intent_lexicon.json
     * `intents.warm.in_game_narrative_zh` 同源。 */
    warm:     '为你释放一段温暖局：多大块、强清行、易爽感。'
};
