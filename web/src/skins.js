...
/**
 * 皮肤总量：36 款（v10.3 mahjong；v10.4 boardgame；v10.5 主题内配色去重 + desert 减亮；v10.6 浅色 farm/desert 哑光降饱和；v10.7 浅色饱和度上限 ≤ 25%；v10.8 带 icon 皮肤强制使用 icon 友好的 blockStyle；v10.17.3 mahjong 重制 — 绿呢牌桌+实木台沿+茶馆暖灯，方块明度跨度 30→73 提升搭配度）
