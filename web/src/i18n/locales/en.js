...
export default {
    ...
    'skin.name.summer': '🏖️ Summer Beach',
    'skin.name.apple': '🍎 Apple Minimal',
    'skin.name.cafe': '☕ Café Afternoon',
    'skin.name.fiesta': '🎉 Fiesta Party',
    ...
    'dfv.reason.pbChase': 'PB chase pressure (priority 102)',
    'dfv.reason.delightStarved': 'delight starved → relief',

    'dfv.rule.pb_chase_pressure': 'PB chase pressure',
    'dfv.rule.relief': 'Frustration relief',
    'dfv.rule.delight_starved': 'Delight starved',
    'dfv.rule.engage': 'AFK engage',
    'dfv.rule.harvest': 'Harvest',
    'dfv.rule.pressure': 'Challenge pressure',
    'dfv.rule.sprint': 'Sprint band',
    'dfv.rule.flow': 'Flow payoff',
    'dfv.rule.maintain': 'Maintain',
    ...
    'dfv.flag.pbChase': 'PB Chase',
    'dfv.flag.delightStarved': 'Delight Starved',
    'dfv.conflicts.label': 'cross-dimension signal conflicts',

    'dfv.sec.phase': 'Pressure phase · Constructive',
    'dfv.sec.phaseSub': 'phaseFreq + constructive',
    'dfv.hint.pressurePhase': 'Pressure phase',
    'dfv.hint.orderSolutionBudget': 'Solution budget',
    'dfv.hint.phaseHighPoolBoost': 'High-phase large boost',
    'dfv.hint.phaseLowPoolClearBoost': 'Low-phase clear boost',
    'dfv.val.pressurePhase.low': 'low',
    'dfv.val.pressurePhase.mid': 'mid',
    'dfv.val.pressurePhase.high': 'high',
    'dfv.phase.pressurePhase': 'Phase',
    'dfv.phase.constructKind': 'Construct kind',
    'dfv.phase.constructDelivered': 'Delivered',
    'dfv.phase.constructCooldown': 'Cooldown',
    'dfv.phase.constructPending': 'From pending',
    'dfv.phase.completerCount': 'Completer cands',
    'dfv.phase.setupCount': 'Setup cands',
    'dfv.phase.lowClearDelivered': 'Low clear OK',
    'dfv.phase.highOrderApplied': 'High order applied',
    'dfv.phase.tip.pressurePhase': 'stress+boardFill → low/mid/high; independent of spawnIntent',
    'dfv.construct.kind.completer': 'C1 completer',
    'dfv.construct.kind.setup': 'C2 setup',
    'dfv.construct.kind.order': 'C3 order anchor',
    'dfv.construct.cooldown': 'Cooldown',
    'dfv.construct.fromPending': 'Pending resume',
    'dfv.val.yes': 'yes',
    'dfv.val.no': 'no',
    'dfv.summary.empty': 'Awaiting first spawn…',
    ...
    'dfv.spark.pressurePhase': 'pressure phase',
    ...
    /* sessionArcAdjust 见下方 v1.67 段（避免重复 key） */
    /* endSessionDistress 见下方 v1.67 段（避免重复 key） */
    ...
    // v1.67: stressBreakdown numeric contributors + diagnostic flags (mirrors stressMeter SIGNAL_LABELS)
    'dfv.contrib.preFrustrationRelief':       'pre-frust relief',
    'dfv.contrib.boardFrustrationRelief':     'board frust relief',
    'dfv.contrib.decisionLoadRelief':         'decision load relief',
    'dfv.contrib.feedbackBiasDampingAdjust':  'feedback damping',
    'dfv.contrib.runOverRunArc':              'run arc',
    'dfv.contrib.runOverRunArcAdjustDelta':   'run arc delta',
    'dfv.contrib.runOverRunArcCapScale':      'run arc cap',
    'dfv.contrib.lifecycleCapAdjust':         'lifecycle cap',
    'dfv.contrib.lifecycleBandAdjust':        'lifecycle band',
    'dfv.contrib.lifecycleStressAdjust':      'lifecycle total',
    'dfv.contrib.lifecycleStage':             'lifecycle stage',
    'dfv.contrib.lifecycleBand':              'lifecycle tier',
    'dfv.contrib.onboardingStressOverrideAdjust': 'onboarding override',
    'dfv.contrib.winbackStressCapAdjust':     'winback cap',
    'dfv.contrib.winbackStressCap':           'winback stress cap',
    'dfv.contrib.clampAdjust':                'clamp',
    'dfv.contrib.smoothingAdjust':            'smoothing',
    'dfv.contrib.smoothingDynamicMaxStepUp':  'smooth max step',
    'dfv.contrib.minStressFloorAdjust':       'min floor',
    'dfv.contrib.flowPayoffCapAdjust':        'flow cap adj',
    'dfv.contrib.flowPayoffCapBypassed':      'flow cap bypass',
    'dfv.contrib.endSessionDistress':         'late session distress',
    'dfv.contrib.sessionArcAdjust':           'session arc adj',
    'dfv.contrib.pbExtremeOrderBoost':        'PB near order',
    'dfv.contrib.farFromPBBoostActive':       'PB far tilt',
    'dfv.contrib.farExtremeBoostActive':      'PB extreme tilt',
    'dfv.contrib.farFromPBBoostBypass':       'PB far bypass',
    'dfv.contrib.challengeBoostBypass':       'B-tier bypass',
    'dfv.contrib.challengeBoostGrowthCapBonus': 'PB growth brake',
    'dfv.contrib.pbOvershootBoost':           'PB overshoot boost',
    'dfv.contrib.pbOvershootActive':          'PB overshoot',
    'dfv.contrib.pbOvershootOrderBoost':      'D4 order lock',
    'dfv.contrib.pbChasePressureActive':      'PB chase pressure',
    'dfv.contrib.pbRatio':                    'PB ratio',
    'dfv.contrib.pbTension':                  'PB tension',
    'dfv.contrib.pbBrake':                    'PB brake',
    'dfv.contrib.pbRelease':                  'PB release',
    'dfv.contrib.pbPhase':                    'PB phase',
    'dfv.contrib.pbCurveParams':              'PB curve params',
    'dfv.contrib.postPbReleaseActive':        'post-PB release',
    'dfv.contrib.expertEarlyBoostActive':     'expert early boost',
    'dfv.contrib.expertEarlyBoostBypass':     'expert early bypass',
    'dfv.contrib.occupancyDamping':           'occupancy damping',
    'dfv.contrib.occupancyDampingBypassed':   'occupancy bypass',
    'dfv.contrib.orderRigor':                 'order rigor',
    'dfv.contrib.bottleneckTrough':           'bottleneck trough',
    'dfv.contrib.bottleneckSamples':          'bottleneck samples',
    'dfv.contrib.tuningV2Source':             'tuning source',
    'dfv.contrib.boardFrustrationReliefBypass': 'board relief bypass',
