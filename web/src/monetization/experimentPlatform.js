...
export { getABTestManager } from './abTestManager.js';
export { getCohortManager } from './cohortManager.js';
export { getRemoteConfigManager } from './remoteConfigManager.js';
export { getAnalyticsTracker } from './analyticsTracker.js';
import { createLogger } from '../lib/logger.js';
const log = createLogger('experimentPlatform');

// 历史问题：原本 `} from './index.js'` 想再导出这四个 getter，但 ./index.js 实际只导出
