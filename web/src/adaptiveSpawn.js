...
import { getLifecycleStressCap, resolveArcLifecycleModifier } from './lifecycle/lifecycleStressCapMap.js';
...
import { applyWarmRun } from './spawn/warmRun.js';
import { applyPeogSpawnHintsCap } from './spawn/peog.js';
/* §4.17/§2.10 难度相对论：体感→客观目标 b* 反解（影子，不改 stress 主线）。
 * §O1：resolveRelativityIntent 把"以什么力度参与"按相位集中决策，与 bypass 互补。 */
import { solveObjectiveTarget, resolveRelativityIntent, RELATIVITY_INTENT } from './difficultyRelativity.js';
...
import { applySpawnPrior, applyRelativityShapePrior } from './bot/spawnPriors.js';
...
} from './bot/liveGeometrySignals.js';
/* v1.71：deriveDelightTuning 抽至 ./bot/delightTuning.js。 */
import { deriveDelightTuning } from './bot/delightTuning.js';
import {
