...
export const CURVE_R_MAX = 1.5;

export const SEG_GENTLE_END = 0.5;
export const SEG_MID_END = 0.95;
export const SEG_BRAKE_END = 1.0;

export const D_BASE = 0.20;
export const D_GENTLE_END = 0.30;
export const D_MID_END = 0.50;
export const D_BRAKE_END = 0.90;
export const D_CAP = 1.00;

export const OVERSHOOT_DECAY = 3.0;
...
export function targetSCurve(r) {
    ...
    if (r < SEG_BRAKE_END) {
        // smoothstep: 3t² - 2t³, 端点 0/1 (与 Python 端一致)
