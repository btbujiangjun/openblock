/*
    ...
    OPENBLOCK PATCH: Removed std::is_floating_point / is_arithmetic / is_signed
    specializations — libc++ (Xcode 16+) forbids specializing those standard
    traits. std::numeric_limits<enoki::half> below remains valid per [numeric.limits].
*/
