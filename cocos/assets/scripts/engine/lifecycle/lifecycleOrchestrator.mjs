/* 自动生成 —— 请勿手改。源：web/src/lifecycle/lifecycleOrchestrator.js
...
import { emit as busEmit } from '../monetization/MonetizationBus.mjs';
import {
    getUnifiedLifecycleSnapshot,
    invalidateLifecycleSnapshotCache,
} from './lifecycleSignals.mjs';
import {
    activateWinback,
    ...
    getActivePreset,
    getWinbackStatus,
} from '../retention/winbackProtection.mjs';
import { buildPlayerAbilityVector } from '../playerAbilityModel.mjs';
import {
    evaluateFirstPurchaseTimingSignal,
    getFunnelData,
} from '../retention/firstPurchaseFunnel.mjs';
import { getFlag } from '../monetization/featureFlags.mjs';
import {
    recordSessionMetrics,
    getChurnData,
    getChurnRiskLevel,
} from '../retention/churnPredictor.mjs';
import {
    shouldTriggerIntervention,
    getInterventionContent,
} from '../retention/playerLifecycleDashboard.mjs';
import { getCommercialChurnRisk01 } from '../monetization/commercialModel.mjs';
import {
    getCommercialModelContext,
    updateRealtimeSignals,
} from '../monetization/personalization.mjs';
import { getAdFreqSnapshot } from '../monetization/adTrigger.mjs';
import { updateMaturity } from '../retention/playerMaturity.mjs';
import { getLifetimeSpend } from '../monetization/iapAdapter.mjs';
