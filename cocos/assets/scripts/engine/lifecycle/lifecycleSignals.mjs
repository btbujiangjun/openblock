/* 自动生成 —— 请勿手改。源：web/src/lifecycle/lifecycleSignals.js
...
import { evaluateWinbackTrigger, getWinbackStatus } from '../retention/winbackProtection.mjs';
import { getMaturityInsights } from '../retention/playerMaturity.mjs';
