 ...
 */
import shapesBundle from './shapesData.mjs';
 ...
 */
export function getRegularShapes() {
 ...
 */
export function getSpecialShapes() {
    return getAllShapes().filter((s) => SPECIAL_ID_SET.has(s.id));
}

/** v1.60.1：独立库 id 列表（与 shared/shapes.json `specialShapeIds` 同源） */
export function getSpecialShapeIds() {
    return [...SPECIAL_IDS_RAW];
}

/** v1.60.1：单 id 速查（O(1)） */
export function isSpecialShapeId(id) {
 ...
 */
export function pickShapeByCategoryWeights(weights, opts) {
