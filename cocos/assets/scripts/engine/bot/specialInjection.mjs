/* 自动生成 —— 请勿手改。源：web/src/bot/specialInjection.js
 ...
 *
 * 循环 import 说明：
 *   本模块 import { ... } from './blockSpawn.mjs'；blockSpawn.js 也 import 本模块。
 *   ESM 顶层只声明函数与 import，运行期才解引用 → 双方链接完成后调用安全。
 *
 * **行为契约**：行为与抽出前严格一致（黄金快照 18 个 / 540 三连样本守护）。
 */

import { defaultRng } from '../lib/seededRng.mjs';
import { getAllShapes } from '../shapes.mjs';
import * as _BS_ESM from './blockSpawn.mjs';

/* 循环依赖处理策略（双轨）：
 *   1. ESM 端（web/cocos .mjs）：`import * as _BS_ESM from './blockSpawn.mjs'` 走 namespace
