/* 自动生成 —— 请勿手改。源：web/src/monetization/leaderboard.js
...
import { getFlag } from './featureFlags.mjs';
import { on } from './MonetizationBus.mjs';
import { getApiBaseUrl } from '../config.mjs';
