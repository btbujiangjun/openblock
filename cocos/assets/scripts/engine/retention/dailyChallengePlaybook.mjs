/* 自动生成 —— 请勿手改。源：web/src/retention/dailyChallengePlaybook.js
...
import { isAndroidLike } from '../config/platformProfile.mjs';
import { safeWriteJson } from '../lib/storageAdapter.mjs';
