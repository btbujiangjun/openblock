/* 自动生成 —— 请勿手改。源：web/src/retention/retentionManager.js
...
import { getDifficultyPredictor, initDifficultyPredictor, predictDifficulty, recordGameResult } from './difficultyPredictor.mjs';
import { getGoalSystem, initGoalSystem } from './goalSystem.mjs';
import { initLevelProgression, getLevelProgression } from './levelProgression.mjs';
