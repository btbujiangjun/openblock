/* 自动生成 —— 请勿手改。源：web/src/lib/beaconSender.js
 ...
 *
 * 用法：
 *   import { createBeaconSender } from './lib/beaconSender.mjs';
 *   import { createBatchSink } from './lib/loggerBatchSink.mjs';
 *   import { setRemoteSink } from './lib/logger.mjs';
 *
 ...
 */
export function createBeaconSender(url, opts = {}) {
