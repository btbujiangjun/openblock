/* 自动生成 —— 请勿手改。源：web/src/lib/userBucketing.js
 ...
 * 用法：
 *
 *   import { resolveRolloutFeature } from './lib/userBucketing.mjs';
 *
 *   // game_rules.json:
 *   //  "rollout": {
 ...
 */
export function xfnv1aHash(str) {
    let h = 2166136261 >>> 0;
    const s = String(str);
 ...
 */
export function getUserBucket(userId, salt = '') {
 ...
 * @returns {boolean}
 */
export function resolveRolloutFeature(userId, config) {
 ...
 * @returns {number}
 */
export function getFeatureBucket(userId, salt = '') {
