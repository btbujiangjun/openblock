/* 自动生成 —— 请勿手改。源：web/src/lib/decisionTable.js
 ...
 */
export function applyDecisionTable(rules, state) {
 ...
 * @returns {any}
 */
export function applyPriorityLadder(ladder, state, defaultValue = null) {
