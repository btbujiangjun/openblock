/* 自动生成 —— 请勿手改。源：web/src/spawn/warmRun.js
...
export const WARM_TARGETS = Object.freeze({
 ...
 */
export function evaluateWarmTriggers(profile, runContext = {}) {
 ...
 */
export function getWarmPhase(budget) {
 ...
 */
export function consumeWarmBudget(budget, delta = {}) {
    if (!budget) return;
 ...
 */
export function shouldExitWarmRun(budget, runContext = {}) {
 ...
 */
export function applyWarmRun(enhancedConfig, ctx, opts = {}) {
 ...
 */
export function formatWarmRunTrace(state) {
...
export const WARM_RUN_INTENT_ID = 'warm';
export const WARM_RUN_PRIORITY = 115; // 高于 pb_chase_pressure(102) 与 relief(100)
export { INTENSITY_RANK as WARM_INTENSITY_RANK };
