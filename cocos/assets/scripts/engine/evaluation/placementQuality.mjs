/* 自动生成 —— 请勿手改。源：web/src/evaluation/placementQuality.js
...
export const PLACEMENT_DEFAULT_WEIGHTS = DEFAULT_WEIGHTS;
export const PLACEMENT_DEFAULT_THROTTLE = DEFAULT_THROTTLE;
export const PLACEMENT_DEFAULT_BADNESS = DEFAULT_BADNESS;
