/* 自动生成 —— 请勿手改。源：web/src/gameRulesRemote.js
...
import { GAME_RULES, _replaceRulesForRemoteSync } from './gameRules.mjs';
import { getUserBucket } from './lib/userBucketing.mjs';
