...
class TestRNDNetworks:
    def test_build_networks(self):
        ...
        # 与 game_rules.json 默认值对齐（STATE_FEATURE_DIM=204）
        cfg = RNDConfig(enabled=True, state_dim=204, hidden_dim=64, output_dim=32)
