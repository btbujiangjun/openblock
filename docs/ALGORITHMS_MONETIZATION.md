...
| [`MONETIZATION.md`](./MONETIZATION.md) | 商业化 v3 全景 |
| [`MONETIZATION_TRAINING_PANEL.md`](./MONETIZATION_TRAINING_PANEL.md) | 面板设计/原理/策略五维 |
| [`MONETIZATION_CUSTOMIZATION.md`](./MONETIZATION_CUSTOMIZATION.md) | 三层定制指南 |
| [`COMMERCIAL_OPERATIONS.md`](./COMMERCIAL_OPERATIONS.md) | 运营视角 |
| [`COMPETITOR_USER_ANALYSIS.md`](./COMPETITOR_USER_ANALYSIS.md) | 竞品分群数据来源 |
| [`MONETIZATION_PERSONALIZATION.md`](./MONETIZATION_PERSONALIZATION.md) | 历史归档 |
