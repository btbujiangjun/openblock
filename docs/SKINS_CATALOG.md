...
- 家畜 + 蔬果，浅暖卡其木栏底
- **icon**：`🐄 🐖 🐑 🐔 🐣 🌽 🥕 🍎`
- 配色：`#B02838` `#1A488F` `#2A7038` `#1A6E9F` `#8E2070` `#B82038` `#1F6038` `#4830B0`
- 风格：`cartoon` · `radius=9` · `cssBg:#EDE0C0`
- **设计要点**：浅色盘面 + 深色饱和块；与 `pets`（家宠）/ `food`（主食）/ `toon`（动物园）完全错开

#### `desert` 🐫 沙漠绿洲

- 骆驼 / 仙人掌 / 古寺 / 赤陶罐
- **icon**：`🐫 🦂 🌵 🏜️ 🪨 🏺 🛕 🌅`
- 配色：`#1F5870` `#E8B860` `#D8A050` `#2A8068` `#C46838` `#2A6048` `#6038A8` `#1F4870`
- 风格：`glossy` · `radius=6` · 沙漠夜空深蓝底
- **专属符号**：🐫🦂🌵🏜️🪨🏺🛕🌅 全部新增
