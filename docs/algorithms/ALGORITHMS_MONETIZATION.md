...
1. [问题域与分层架构](#一问题域与分层架构)
2. [鲸鱼分模型（whale_score）](#二鲸鱼分模型whale_score)
3. [实时信号体系](#三实时信号体系)
4. [策略规则引擎（L2）](#四策略规则引擎l2)
5. [active 判定与排序](#五active-判定与排序)
6. [whyLines 推理摘要](#六whylines-推理摘要)
7. [LTV 预测器](#七ltv-预测器)
8. [CommercialModelVector：模型化商业决策](#八commercialmodelvector模型化商业决策)
9. [广告触发与 Cap 算法](#九广告触发与-cap-算法)
10. [配置覆盖与热更新](#十配置覆盖与热更新)
11. [缓存与一致性](#十一缓存与一致性)
12. [完整公式速查](#十二完整公式速查)
13. [完整参数表](#十三完整参数表)
14. [演进与开放问题](#十四演进与开放问题)
15. [算法层扩展模块](#十五算法层扩展模块)
...
## 八、CommercialModelVector：模型化商业决策
