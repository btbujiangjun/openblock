...
| [`MONETIZATION.md`](../operations/MONETIZATION.md) | 商业化系统全景 |
| [`MONETIZATION_TRAINING_PANEL.md`](../operations/MONETIZATION_TRAINING_PANEL.md) | MonPanel 字段、界面与调试 |
| [`MONETIZATION_CUSTOMIZATION.md`](../operations/MONETIZATION_CUSTOMIZATION.md) | 策略定制指南 |
| [`COMMERCIAL_OPERATIONS.md`](../operations/COMMERCIAL_OPERATIONS.md) | 运营机会池与参考分析 |
...
> 最后更新：2026-05-04 · 增加商业化建模方法对比、CommercialModelVector loss 口径与参数表
> 维护：算法工程团队
