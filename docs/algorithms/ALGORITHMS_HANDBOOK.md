...
| [`ALGORITHMS_SPAWN.md`](./ALGORITHMS_SPAWN.md) | [`ALGORITHMS_SPAWN.md`（§12）](./ALGORITHMS_SPAWN.md#十二出块算法架构总览工程分层) / [`ADAPTIVE_SPAWN.md`](./ADAPTIVE_SPAWN.md) / [`ALGORITHMS_SPAWN.md`（§13）](./ALGORITHMS_SPAWN.md#十三出块建模双轨实现与设计-rationale) / [`ALGORITHMS_SPAWN.md`（§16）](./ALGORITHMS_SPAWN.md#十六局间难度ror) / [`ALGORITHMS_SPAWN.md`（§17）](./ALGORITHMS_SPAWN.md#十七温暖局warm-run) | [`DIFFICULTY_MODES.md`](../product/DIFFICULTY_MODES.md) |
