...
>
> **相关**：本文聚焦*模式级*难度（玩家可选的三档）；若需*单步级*难度量化（盘面 × 候选三块的客观/表现难度指标、与外部提案的 61 指标对照、P0–P6 优化路线），见 [`../algorithms/ALGORITHMS_SPAWN.md` §14.二 单步难度细化](../algorithms/ALGORITHMS_SPAWN.md#14-出块难度与评估)。
