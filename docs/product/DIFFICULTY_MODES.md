...
>
> **相关**：本文聚焦*模式级*难度（玩家可选的三档）；若需*单步级*难度量化（盘面 × 候选三块的客观/表现难度指标、与外部提案的 61 指标对照、P0–P6 优化路线），见 [`../algorithms/ALGORITHMS_SPAWN.md` §14.二 单步难度细化](../algorithms/ALGORITHMS_SPAWN.md#十四出块难度与评估)。
...
- [二、全链路追踪](#二全链路追踪)
- [三、三档参数对比](#三三档参数对比)
- [四、自适应系统与难度的交互](#四自适应系统与难度的交互)
- [五、发现的问题与修复](#五发现的问题与修复)
- [六、设计原理](#六设计原理)
- [七、涉及文件](#七涉及文件)
- [八、后续方向](#八后续方向)
