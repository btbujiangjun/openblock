...
4. [个性化策略矩阵](#四个性化策略矩阵)
5. [功能模块详解](#五功能模块详解)
6. [后端 API 参考](#六后端-api-参考)
7. [SQLite 数据库结构](#七sqlite-数据库结构)
8. [配置与调参](#八配置与调参)
9. [玩家画像面板集成](#九玩家画像面板集成)
10. [商业化模型训练面板](#十商业化模型训练面板)
11. [Feature Flag 开关](#十一feature-flag-开关)
12. [当前实现状态](#十二当前实现状态)
13. [指标基线](#十三指标基线)
14. [扩展边界](#十四扩展边界)
...
### 2 商业化扩展表（backend/monetization_backend.py 建立）
...
| [`ALGORITHMS_SPAWN.md`（十三）](../algorithms/ALGORITHMS_SPAWN.md#十三出块建模双轨实现与设计-rationale) | 出块算法（留存核心引擎，商业化底层支撑） |
