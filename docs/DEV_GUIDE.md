...
当前小程序已对齐的 Web 能力包括：36 款皮肤（其中 26 款带 `blockIcons`，全局 208 个 emoji 唯一）、20 关关卡包、同色/同 icon bonus 计分、完整消行动画链，以及出块危险态保命策略。皮肤详情见 [SKINS_CATALOG.md](./SKINS_CATALOG.md)。
