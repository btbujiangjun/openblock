...
| **🧠 算法 / AI 工程师** — 出块、玩家画像、RL | [算法与模型手册](./algorithms/ALGORITHMS_HANDBOOK.md) · [出块算法](./algorithms/ALGORITHMS_SPAWN.md) · [RL 算法](./algorithms/ALGORITHMS_RL.md) · [出块信号透视仪](./algorithms/spawn-signal-explorer.html) |
...
| **🔧 运维 / SRE** — 部署、监控、安全 | [部署指南](./operations/DEPLOYMENT.md) · [可观测性](./operations/OBSERVABILITY.md) · [安全加固](./operations/SECURITY_HARDENING.md) |
...
> 在线查阅：启动服务后访问 `/docs` 即可浏览全部文档 | [项目 GitHub](https://github.com/anomalyco/openblock)
